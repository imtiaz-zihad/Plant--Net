...
const SellerOrderDataRow = ({orderData,refetch}) => {
  ...
  const { name, customer,address, price, quantity, _id, status,plantId } = orderData ||{};
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        {address? <p className='text-gray-900 whitespace-no-wrap'>{address}</p> : <p className='text-gray-900 whitespace-no-wrap'>Not Available</p>}
      </td>
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
